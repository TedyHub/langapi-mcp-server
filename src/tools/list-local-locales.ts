...
export function registerListLocalLocales(server: McpServer): void {
  server.tool(
    "list_local_locales",
    "Scan project for locale JSON files, detect i18n framework (next-intl, i18next, react-intl, generic), and return structured information about available translations.",
